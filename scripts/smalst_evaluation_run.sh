...
python -m smal_eval --name=smal_net_600 --img_path='zebra_testset/' --num_train_epoch=186 --use_annotations=True --mirror=True --segm_eval=True --img_ext='.jpg' --anno_path='zebra_testset/annotations'
